...
from emo_tts.model import CFM, DiT, Trainer, UNetT
from emo_tts.model.dataset import load_dataset
from emo_tts.model.utils import get_tokenizer
...
def parse_args():
    ...
    parser.add_argument(
        "--exp_name",
        type=str,
        default="EmoTTS_v1_Base",
        choices=["EmoTTS_v1_Base", "EmoTTS_Base", "E2TTS_Base"],
...
def main():
    ...
    checkpoint_path = str(files("emo_tts").joinpath(f"../../ckpts/{args.dataset_name}"))

    # Model parameters based on experiment name

    if args.exp_name == "EmoTTS_v1_Base":
    ...
    elif args.exp_name == "EmoTTS_Base":
        wandb_resume_id = None
        model_cls = DiT
        model_cfg = dict(
            dim=1024,
