# put in src/emo_tts/train/datasets/prepare_emilia_v2.py
...
from emo_tts.model.utils import repetition_found
...
if __name__ == "__main__":
    ...
    # save_dir = os.path.expanduser(f"~/Emo-TTS/data/{dataset_name}")
    save_dir = str(files("emo_tts").joinpath("../../")) + f"/data/{dataset_name}"
