...
class TTSStreamingProcessor:
    def __init__(self, model, ckpt_file, vocab_file, ref_audio, ref_text, device=None, dtype=torch.float32):
        ...
        self.model_cls = get_class(f"emo_tts.model.{model_cfg.model.backbone}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="The model name, e.g. EmoTTS_v1_Base",
    )
    parser.add_argument(
        "--ckpt_file",
        default=str(hf_hub_download(repo_id="SWivid/Emo-TTS", filename="EmoTTS_v1_Base/model_1250000.safetensors")),
    ...
    parser.add_argument(
        "--ref_audio",
        default=str(files("emo_tts").joinpath("infer/examples/basic/basic_ref_en.wav")),
