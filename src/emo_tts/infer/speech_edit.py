...
from emo_tts.infer.utils_infer import load_checkpoint, load_vocoder, save_spectrogram
from emo_tts.model import CFM
from emo_tts.model.utils import convert_char_to_pinyin, get_tokenizer
...
exp_name = "EmoTTS_v1_Base"  # EmoTTS_v1_Base | E2TTS_Base
ckpt_step = 1250000
...
model_cfg = OmegaConf.load(str(files("emo_tts").joinpath(f"configs/{exp_name}.yaml")))
model_cls = get_class(f"emo_tts.model.{model_cfg.model.backbone}")
...
# ckpt_path = str(files("emo_tts").joinpath("../../")) + f"/ckpts/{exp_name}/model_{ckpt_step}.safetensors"
ckpt_path = str(cached_path(f"hf://SWivid/Emo-TTS/{exp_name}/model_{ckpt_step}.safetensors"))
output_dir = "tests"
...
# ctc-forced-aligner --audio_path "src/emo_tts/infer/examples/basic/basic_ref_en.wav" --text_path "tests/test_edit.txt" --language "zho" --romanize --split_size "char"
# [result will be saved at same path of audio file]
# [--language "zho" for Chinese, "eng" for English]
# [if local ckpt, set --alignment_model "../checkpoints/mms-300m-1130-forced-aligner"]

audio_to_edit = str(files("emo_tts").joinpath("infer/examples/basic/basic_ref_en.wav"))
...
# audio_to_edit = "src/emo_tts/infer/examples/basic/basic_ref_zh.wav"
