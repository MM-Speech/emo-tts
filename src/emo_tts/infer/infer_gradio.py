...
from emo_tts.infer.utils_infer import (
    infer_process,
    load_model,
    load_vocoder,
...
from emo_tts.model import DiT, UNetT


DEFAULT_TTS_MODEL = "Emo-TTS_v1"
tts_model_choice = DEFAULT_TTS_MODEL

DEFAULT_TTS_MODEL_CFG = [
    "hf://SWivid/Emo-TTS/EmoTTS_v1_Base/model_1250000.safetensors",
    "hf://SWivid/Emo-TTS/EmoTTS_v1_Base/vocab.txt",
...
def load_emotts():
    ...
    EmoTTS_model_cfg = json.loads(DEFAULT_TTS_MODEL_CFG[2])
    return load_model(DiT, EmoTTS_model_cfg, ckpt_path)
...
with gr.Blocks() as app_tts:
    ...
    # Workaround for https://github.com/SWivid/Emo-TTS/issues/1239#issuecomment-3677987413
...
* [mrfakename](https://github.com/fakerybakery) for the original [online demo](https://huggingface.co/spaces/mrfakename/E2-Emo-TTS)
...
This is {"a local web UI for [Emo-TTS](https://github.com/SWivid/Emo-TTS)" if not USING_SPACES else "an online demo for [Emo-TTS](https://github.com/SWivid/Emo-TTS)"} with advanced batch processing support. This app supports the following TTS models:

* [Emo-TTS](https://arxiv.org/abs/2410.06885) (A Fairytaler that Fakes Fluent and Faithful Speech with Flow Matching)
...
"""
    ...
    last_used_custom = files("emo_tts").joinpath("infer/.cache/last_used_custom_model_info_v1.txt")
