...
async def listen_to_EmoTTS(text, server_ip="localhost", server_port=9998):
    ...
    try:
        ...
        logger.error(f"Error in listen_to_EmoTTS: {e}")
...
if __name__ == "__main__":
    ...
    asyncio.run(listen_to_EmoTTS(text_to_send))
